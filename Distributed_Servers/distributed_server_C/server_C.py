...
# PORT = 8003	# int(input('Enter Arbitrary non-privileged port no. :'))
...
print("Server C now listening at address => " + HOST + " :", PORT)


def verify_user(username, password):
	with open('login_credentials_C.csv', 'r') as credentials_file:
