...
# PORT = 8001	# int(input('Enter Arbitrary non-privileged port no. :'))
...
print("Server A now listening at address => " + HOST + " :", PORT)


def verify_user(username, password):
	with open('login_credentials_A.csv', 'r') as credentials_file:
