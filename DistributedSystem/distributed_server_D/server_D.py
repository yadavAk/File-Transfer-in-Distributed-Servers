...
# PORT = 8004	# int(input('Enter Arbitrary non-privileged port no. :'))
...
print("Server D now listening at address => " + HOST + " :", PORT)


def verify_user(username):
	with open('attendance.csv', 'r') as credentials_file:
...
def clientthread(conn, addr):
	...
	reply = str(int(verify_user(data[0])))
